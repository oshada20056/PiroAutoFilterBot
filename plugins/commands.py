    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('F I L M _ X Y Z', url=f"https://t.me/FilmStudiohub2") ] ] ),
            )
        return
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('F I L M _ X Y Z', url="https://t.me/FilmStudiohub2") ] ] ),
            )
            filetype = msg.media
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('F I L M _ X Y Z')
